    ...
    >
            ...
            <?php foreach ($navItems as $item): ?>
                ...
                <li>
                    ...
                    <!--
                        ...
                        JavaScript below handles navigation.
                    -->
        ...
        <div class="loan-mobile-user">
            ...
            <div class="dropdown">
                ...
                <ul
                    class="dropdown-menu loan-user-dropdown"
                >
    ...
    mobileLinks.forEach(function (link) {
        ...
        link.addEventListener(
            ...
            function (event) {
                ...
                /*
                 * Navigate after the offcanvas
                 * starts closing.
                 *
                 * Small delay prevents the
                 * Bootstrap animation from
