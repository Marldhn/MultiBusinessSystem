...
<div
    class="modal fade"
    id="customerDetailsModal<?= $customer['id'] ?>"
    tabindex="-1"
>
...
<div class="purchase-summary-label">
Phone
</div>
...
try {
    ...
    $totalPurchases = count($purchaseHistory);

    foreach ($purchaseHistory as $purchase) {

        $totalSpent += (float)($purchase['total_amount'] ?? 0);
...
<div class="purchase-summary-value text-primary">
...
All POS purchases made by this customer
...
<i class="bi bi-receipt display-5 text-muted opacity-50"></i>
...
This customer does not have any POS transactions.
...
<?php if ($purchaseStatus === 'completed'): ?>

<span class="badge text-bg-success">
Completed
</span>

<?php elseif ($purchaseStatus === 'cancelled'): ?>
